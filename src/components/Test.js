...
class Test extends React.Component {
    ...
    testURL() {
        ...
        let url = "http://localhost:8084/security/oauth/token?grant_type=password&scope=read+write&client_id=my-trusted-client&client_secret=secret&username=hoangnh&password=nlntmttaum";
        xhr.open('POST', url);
    ...
    render() {
        ...
        return (
            <div>
                <form>
                    <InputText fullWidth={true} name="url" value="http://localhost:8084/security/oauth/token" label={ t1(intl, 'Url')}/>
