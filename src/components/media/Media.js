...
import MediaLeftMenu from "./controls/MediaLeftMenu";
import ListMedia from "./views/ListMedia";
import Dropzone from "react-dropzone";
import {mediaListRootURL, mediaListURL, mediaUploadURL} from './MediaDefinedUrl';
import {onMMDataLoaded, setMediaMenuContextState} from "./MediaActions";
            ...
            <div className="ui-media-panel ">
                <div className="ui-control-panel clearfix">
                    <div className="pull-left">
                        <MediaControl onGoToBackFolder={this.goToBackFolder} uploadMedia={this.onUploadMediaStart}/>
                    </div>
